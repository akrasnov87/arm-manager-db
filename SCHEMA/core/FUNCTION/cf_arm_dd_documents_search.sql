CREATE OR REPLACE FUNCTION core.cf_arm_dd_documents_search(_txt text) RETURNS TABLE(id integer, n_number integer, c_fio text, c_document text, c_address text, c_account text, c_accept text, c_notice text)
    LANGUAGE plpgsql STABLE
    AS $$
/**
* @params {text} _txt - текст для поиска
*
* @example
